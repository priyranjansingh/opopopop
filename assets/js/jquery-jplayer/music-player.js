        ...
        playlistMgr = function() {
            ...
            markup = {
                listItem:'<li class="track">' +
                            '<div class="track-title-cat"><h6 class="title"></h6><br>' +
                            '<span class="artist">Cowboy</span></div>'+
                            '<div class="track-duration"><span class="duration"></span>' +
                            '<a href="#" class="buy not-active" target="_blank"></a></div>' +
                        '</li>',
            ...
            function init(playlistOptions) {
                ...
                $myJplayer = $('.music-player .jPlayer-container');
        ...
        interfaceMgr = function() {
            ...
            function buildInterface() {
                var markup, $interface;
                    ...
                    markup = '<div class="music-player">' +
                            '<div class="player jp-interface">' +
                            '<div class="track-top">'+
                            '        <div class="track-info">' +
                            '            <h6 class="title"></h6>' +
                            '            <h6 class="artist-outer"> <span class="artist"></span></h6>' +
                            '        </div>' +
                            ...
                            '            </div>' +
                            '            <div class="main">' +
                            '                <div class="previous jp-previous"><i class="fa fa-step-backward"></i></div>' +
                            '                <div class="play jp-play"><i class="fa fa-play"></i></div>' +
                            '                <div class="pause jp-pause"><i class="fa fa-pause" aria-hidden="true"></i></div>' +
                            '                <div class="next jp-next"><i class="fa fa-step-forward"></i></div>' +
                            '            </div>' +
                    ...
                    if($('.list-play').length){
                        markup = '<div class="music-player">' +
                            ...
                            '           <div class="player-controls">' +
                            '               <div class="progress-wrapper">' +
                            '                    <div class="progress jp-seek-bar"></div>' +
                            '                    <div class="elapsed jp-play-bar"></div>' +
                            '                </div>' +
                            '            </div>' +
                            '            <h6 class="artist-outer"> <span class="artist"></span></h6>' +
                            ...
                            '               <span class="jp-video-play"></span>' +
                            '               <span class="jp-stop"></span>' +
                            '               <span class="jp-mute" role="button" tabindex="0"><i class="fa fa-volume-up"></i></span>' +
                            '               <span class="jp-unmute"><i class="fa fa-volume-off"></i></span>' +
                            '               <span class="jp-volume-bar">'+
                            '                   <span class="jp-volume-bar-value"></span>' +
                            '               </span>' +
                            '               <span class="jp-volume-max" role="button" tabindex="0"></span>' +
                            '               <span class="jp-current-time"></span>' +
                            '               <span class="jp-duration"></span>' +
                            '               <span class="jp-full-screen"></span>' +
                            '               <span class="jp-restore-screen"></span>' +
